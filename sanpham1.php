            ...
            <div class="row">
                ...
                if (!isset($_GET['p_cat'])) {
                    ...
                    if (!isset($_GET['cat'])) {
                        ...
                        $get_products = "select * from sanpham order by 1 DESC LIMIT $start_from,$per_page";
            ...
            <?php
                        ...
                        echo "
                                     ...
                                     <li>
                                         ...
                                         <a href='sanpham1.php?page=1'> " . 'First Page' . " </a>
                        ...
                        for ($i = 1; $i <= $total_pages; $i++) {
                            ...
                            echo "
                                     ...
                                     <li>
                                         ...
                                         <a href='sanpham1.php?page=" . $i . "'> " . $i . " </a>
                        ...
                        echo "
                                     ...
                                     <li>
                                         ...
                                         <a href='sanpham1.php?page=$total_pages'> " . 'Last Page' . " </a>
