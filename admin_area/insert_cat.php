    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Danh mục / Thêm loại sản phẩm
...
<?php  
          ...
          if(isset($_POST['submit'])){
              ...
              $insert_cat = "insert into phanloai (ten_phanloai,mota_phanloai) values ('$cat_title','$cat_desc')";
              
              $run_cat = mysqli_query($links,$insert_cat);
