    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Danh mục / Thêm danh mục sản phẩm
...
<?php  
          ...
          if(isset($_POST['submit'])){
              ...
              $insert_p_cat = "insert into thuonghieu (ten_nhanhang,mota_nhanhang) values ('$p_cat_title','$p_cat_desc')";
              
              $run_p_cat = mysqli_query($links,$insert_p_cat);
