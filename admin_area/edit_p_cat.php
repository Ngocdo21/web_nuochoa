...
<?php 
    ...
    if(isset($_GET['edit_p_cat'])){
        ...
        $edit_p_cat_query = "select * from thuonghieu where id_nhanhang='$edit_p_cat_id'";
        
        $run_edit = mysqli_query($links,$edit_p_cat_query);
        
        $row_edit = mysqli_fetch_array($run_edit);
        
        $p_cat_id = $row_edit['id_nhanhang'];
        
        $p_cat_title = $row_edit['ten_nhanhang'];
        
        $p_cat_desc = $row_edit['mota_nhanhang'];
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              $update_p_cat = "update thuonghieu set ten_nhanhang='$p_cat_title',mota_nhanhang='$p_cat_desc' where id_nhanhang='$p_cat_id'";
              
              $run_p_cat = mysqli_query($links,$update_p_cat);
