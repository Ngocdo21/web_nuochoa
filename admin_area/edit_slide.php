...
<?php 
    ...
    if(isset($_GET['edit_slide'])){
        ...
        $run_edit_slide = mysqli_query($links,$edit_slide);
        
        $row_edit_slide = mysqli_fetch_array($run_edit_slide);
        
        $slide_id = $row_edit_slide['id_slide'];
        
        $slide_name = $row_edit_slide['ten_slide'];
        
        $slide_image = $row_edit_slide['anh_slide'];
...
<?php  
    ...
    if(isset($_POST['update'])){
        ...
        $update_slide = "update slider set ten_slide='$slide_name',anh_slide='$slide_image' where id_side='$slide_id'";
        
        $run_update_slide = mysqli_query($links,$update_slide);
