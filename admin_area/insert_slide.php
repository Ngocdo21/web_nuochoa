    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Danh sách / Thêm Slide
...
<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        $view_run_slide = mysqli_query($links,$view_slides);
        ...
        if($count<4){
            ...
            $insert_slide = "insert into slider (ten_slide,anh_slide) values ('$slide_name','$slide_image')";
            
            $run_slide = mysqli_query($links,$insert_slide);
           ...
           echo "<script>alert('Bạn đã thêm 4 slides')</script>"; 
